...
// 차트 프레임
export const getMonthChartFrame = (title) => {
    ...
    frame.appendTo($(".chart_holder"));
    return frame;
}

export const getLocationChartFrame = (title) => {
...
// Chart.js쓰는 레거시 버전
export const getMonthChartFrameLegacy = (title) => {
...
export const getLocationChartFrameLegacy = (title) => {
